...
import com.example.ch6.databinding.DialogCountdownSettingBinding
import java.util.*
...
class MainActivity : AppCompatActivity() {
    ...
    private fun start() {
        timer = timer(initialDelay = 0, period = 100) {
            ...
            if (currentDeciSecond == 0 && currentCountdownDeciSecond < 31 && currentCountdownDeciSecond % 10 == 0){
                val toneType = if(currentCountdownDeciSecond == 0) ToneGenerator.TONE_CDMA_CALL_SIGNAL_ISDN_SP_PRI else ToneGenerator.TONE_SUP_RADIO_NOTAVAIL
    ...
    private fun stop() {
        ...
        binding.lapContainorLinearLayout.removeAllViews()
    }
    ...
    private fun lap() {
        val container = binding.lapContainorLinearLayout
